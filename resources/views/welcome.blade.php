            ...
            <div class="jumbotron content">
                ...
                <form class="form" method="post" action="{{ route('index') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="teams" placeholder="Enter no of teams">
                    </div>
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary" type="button">Generate result</button>
                    </div>
                </form>       
            <div>
        </div>
